...
from sqlalchemy import  Column, String, Integer, SmallInteger, Numeric, DateTime, Sequence, create_engine
...
if __name__ == "__main__":
    # This checks if the table exists; if not, it creates it.
    Base.metadata.create_all(engine)
    print("✅ Database structure is synchronized.")

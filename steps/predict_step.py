...
from zenml.integrations.bentoml.services.bentoml_local_deployment import BentoMLLocalDeploymentService
...
def predictor(
    ...
    prediction = service.predict("predict", inference_data)
